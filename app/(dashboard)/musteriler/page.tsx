  ...
  return (
    <>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className={cn(
              ...
              isPurple ? "bg-purple-50 text-purple-700" : "bg-blue-50 text-blue-700"
            )}>
        ...
        {/* Filters Bar */}
        <div className="flex flex-col gap-4 rounded-xl border border-border bg-card p-4 shadow-sm md:flex-row md:items-center transition-colors">
          <div className="relative flex-1">
            ...
            <input
              ...
              className={cn(
                "w-full rounded-lg border py-2 pl-10 pr-4 text-sm text-foreground bg-background outline-none transition-colors",
                isPurple
                    ...
                    <tr key={customer.id} className="group hover:bg-muted/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-center gap-2">
                          <Link href={`/musteriler/${customer.id}`} className={cn(
                            "rounded p-1.5 text-muted-foreground transition-colors",
                            isPurple ? "hover:bg-purple-50 hover:text-purple-600" : "hover:bg-blue-50 hover:text-blue-600"
                          )} title="Detay">
            ...
            <div className="flex items-center justify-between border-t border-border px-6 py-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  disabled={page === 1}
                  className="flex items-center gap-1 rounded-lg border border-border px-3 py-1.5 text-sm font-medium text-muted-foreground hover:bg-muted disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
